...
std::string GetHipblasltVersion() { return TF_HIPBLASLT_SOVERSION; }
std::string GetMiopenVersion() { return TF_MIOPEN_SOVERSION; }
std::string GetHipfftVersion() { return TF_HIPFFT_SOVERSION; }
