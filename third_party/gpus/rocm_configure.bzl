...
def _rocm_include_path(repository_ctx, rocm_config, bash_bin):
    ...
    inc_dirs.append(rocm_config.llvm_path + "/lib/clang/8.0/include")
    inc_dirs.append(rocm_config.llvm_path + "/lib/clang/9.0.0/include")
    inc_dirs.append(rocm_config.llvm_path + "/lib/clang/10.0.0/include")
    inc_dirs.append(rocm_config.llvm_path + "/lib/clang/11.0.0/include")
