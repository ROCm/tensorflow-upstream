...
//#include "tensorflow/compiler/xla/service/cpu/runtime_handle_ffi_call.h"  // NOLINT
...
#include "tensorflow/compiler/xla/service/cpu/onednn_softmax.h"
#endif
...
SimpleOrcJIT::SimpleOrcJIT(
    ...
    const llvm::TargetOptions& target_options, llvm::CodeGenOpt::Level opt_level,
...
std::unique_ptr<SimpleOrcJIT> SimpleOrcJIT::Create(
    const llvm::TargetOptions& target_options, llvm::CodeGenOpt::Level opt_level,
    bool optimize_for_size, bool disable_expensive_passes,
    //bool disable_slp_vectorizer, llvm::FastMathFlags fast_math_flags,
    LLVMCompiler::ModuleHook pre_optimization_hook,
    LLVMCompiler::ModuleHook post_optimization_hook,
    std::function<void(const llvm::object::ObjectFile&)>
        post_codegen_hook) {
