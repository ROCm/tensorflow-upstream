...
//   static StatusOr<absl::optional<AutotunerCompileUtil>> Create(
...
//   // `(cache_key, config)`. Returns `absl::nullopt` on expected failure, bad
//   // `Status` otherwise.
//   StatusOr<absl::optional<ProfilingOutput>> ProfileExecutable(
