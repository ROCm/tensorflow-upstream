...
#include "tensorflow/compiler/xla/stream_executor/cuda/cuda_asm_compiler.h"
...
#include "tensorflow/compiler/xla/stream_executor/typed_kernel_factory.h"
#include "tsl/platform/statusor.h"

namespace stream_executor {
// Maintains a cache of pointers to loaded kernels
template <typename... Args>
static StatusOr<TypedKernel<Args...>*> LoadKernelOrGetPtr(
...
StatusOr<const ComparisonKernel*> GetComparisonKernel(
