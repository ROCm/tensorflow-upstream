...
static port::Status RunRedzoneChecker(
    Stream* stream, const DeviceMemory<uint8>& redzone,
    uint8 redzone_pattern, const DeviceMemory<uint64>& out_param,
...
static port::StatusOr<RedzoneCheckStatus> CheckRedzonesForBuffer(
    ...
    const ComparisonKernel& comparison_kernel, int64 user_allocation_size,
