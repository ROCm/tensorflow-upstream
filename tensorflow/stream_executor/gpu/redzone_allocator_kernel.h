...
#ifndef TENSORFLOW_STREAM_EXECUTOR_GPU_REDZONE_ALLOCATOR_KERNEL_H_
#define TENSORFLOW_STREAM_EXECUTOR_GPU_REDZONE_ALLOCATOR_KERNEL_H_
...
using ComparisonKernel = TypedKernel<DeviceMemory<uint8>, uint8, uint64,
                                     DeviceMemory<uint64>>;
...
#endif  // TENSORFLOW_STREAM_EXECUTOR_GPU_REDZONE_ALLOCATOR_KERNEL_H_
