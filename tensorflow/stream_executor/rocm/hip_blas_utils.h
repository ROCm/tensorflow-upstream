...
#ifndef TENSORFLOW_STREAM_EXECUTOR_ROCM_HIP_BLAS_UTILS_H_
#define TENSORFLOW_STREAM_EXECUTOR_ROCM_HIP_BLAS_UTILS_H_
...
#endif  // TENSORFLOW_STREAM_EXECUTOR_ROCM_HIP_BLAS_UTILS_H_
