...
bazel \
        ...
        -- @local_xla//xla/service/gpu/transforms:block_scaling_rewriter_hipblaslt_test

# @local_xla//xla/service/gpu/transforms:block_scaling_rewriter_test_gpu_amd_any
