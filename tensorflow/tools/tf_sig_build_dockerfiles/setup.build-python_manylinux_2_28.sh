...
if [ "$PYTHON_VERSION" = "3.9" ]; then
    wget https://www.python.org/ftp/python/3.9.19/Python-3.9.19.tgz && tar xvf Python-3.9.19.tgz && cd Python-3.9*/ && ./configure --enable-optimizations && make altinstall
    ...
    wget https://www.python.org/ftp/python/3.10.14/Python-3.10.14.tgz && tar xvf Python-3.10.14.tgz && cd Python-3.10*/ &&
    ...
    wget https://www.python.org/ftp/python/3.11.9/Python-3.11.9.tgz && tar xvf Python-3.11.9.tgz && cd Python-3.11*/ &&
        sed -i 's/PKG_CONFIG openssl /PKG_CONFIG openssl11 /g' configure && ./configure --enable-optimizations && make altinstall
