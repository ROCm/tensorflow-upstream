...
#include "gather_attention_pipeline_policy.hpp"
#include "gather_attention_problem.hpp"

namespace ck_tile {

template <typename GatherAttentionProblem_, typename GatherAttentionTraits_>
struct BlockGatherAttentionPipeline {
  using Problem = remove_cvref_t<GatherAttentionProblem_>;
  using Traits = remove_cvref_t<GatherAttentionTraits_>;

  using Policy = GatherAttentionPolicy;
  ...
  using GatherAttentionTileShape =
      remove_cvref_t<typename Problem::GatherAttentionTileShape>;

  static constexpr index_t kM = GatherAttentionTileShape::kM;
  static constexpr index_t kN0 = GatherAttentionTileShape::kN0;
  static constexpr index_t kK0 = GatherAttentionTileShape::kK0;
  static constexpr index_t kN1 = GatherAttentionTileShape::kN1;
  static constexpr index_t kK1 = GatherAttentionTileShape::kK1;
  static constexpr index_t kMaxK = GatherAttentionTileShape::kMaxK;
  ...
  CK_TILE_HOST_DEVICE static constexpr ck_tile::index_t GetSmemSize() {
    return Policy::GetGatherAttentionSmemSize<Problem>();
  }
