...
struct GatherAttentionPolicy {
  template <typename Problem>
  CK_TILE_HOST_DEVICE static constexpr index_t GetGatherAttentionSmemSize() {
  ...
  CK_TILE_HOST_DEVICE static constexpr auto MakeADramTileDistribution() {
    ...
    constexpr index_t Gemm1NWarp =
        Problem::GatherAttentionTileShape::NumWarpsGemm1 /
        Problem::GatherAttentionTileShape::NumWarpsGemm0;

    constexpr index_t kMPerBlock = Problem::GatherAttentionTileShape::kM;
    constexpr index_t kKPerBlock = Problem::GatherAttentionTileShape::kK0;
    constexpr index_t kMaxK = Problem::GatherAttentionTileShape::kMaxK;
  ...
  CK_TILE_HOST_DEVICE static constexpr auto MakeB0DramTileDistribution() {
    ...
    constexpr index_t kNPerBlock = Problem::GatherAttentionTileShape::kN0;
    constexpr index_t kKPerBlock = Problem::GatherAttentionTileShape::kK0;
  ...
  CK_TILE_HOST_DEVICE static constexpr auto GetAB0BlockGemm() {
    using BlockGemmProblem = BlockGemmPipelineProblem<
        ...
        TileGemmShape<Problem::GatherAttentionTileShape::kM,
                      Problem::GatherAttentionTileShape::kN0,
                      Problem::GatherAttentionTileShape::kK0>>;
    ...
    using BlockGemmPolicy = BlockGemmARegBSmemCRegV1CustomPolicy<
        ...
        typename Problem::GatherAttentionTileShape::Gemm0BlockWarps,
        decltype(warp_gemm)>;
  ...
  CK_TILE_HOST_DEVICE static constexpr auto MakeB1TDramTileDistribution() {
    ...
    constexpr index_t kNPerBlock = Problem::GatherAttentionTileShape::kN1;
    constexpr index_t kKPerBlock = Problem::GatherAttentionTileShape::kK1;
  ...
  CK_TILE_HOST_DEVICE static constexpr auto GetPB1TBlockGemm() {
    using BlockGemmProblem = BlockGemmPipelineProblem<
        ...
        typename Problem::GemmAccDataType, Problem::kBlockSize,
        TileGemmShape<Problem::GatherAttentionTileShape::kM,
                      Problem::GatherAttentionTileShape::kN1,
                      Problem::GatherAttentionTileShape::kK1>>;
    ...
    using BlockGemmPolicy = BlockGemmARegBSmemCRegV1CustomPolicy<
        typename Problem::InOutDataType, typename Problem::InOutDataType,
        typename Problem::GemmAccDataType,
        typename Problem::GatherAttentionTileShape::Gemm1BlockWarps,
        decltype(warp_gemm)>;
