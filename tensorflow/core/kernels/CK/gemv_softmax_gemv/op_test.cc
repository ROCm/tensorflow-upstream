...
TEST_F(GemvSoftmaxGemvTest, Simple) {
    ...
    RunUnfusedGemvSoftmaxGemvTest<Eigen::half>(mat_A, mat_B0, keymask, mat_B1, mat_D, head_sz, seq, b);
    RunGemvSoftmaxGemvTest<Eigen::half>(mat_A, mat_B0, keymask, mat_B1, mat_D, head_sz, seq, b);
}
