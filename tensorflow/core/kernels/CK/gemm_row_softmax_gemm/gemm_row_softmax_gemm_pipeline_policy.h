...
struct GemmRowSoftmaxGemmPolicy
{
    ...
    CK_TILE_HOST_DEVICE static constexpr index_t GetGemmRowSoftmaxKernelSmemSize()
    {
    ...
    CK_TILE_HOST_DEVICE static constexpr auto MakeA0DramTileDistribution()
    {
        ...
        constexpr index_t K2 =
            min(kMPerBlock * kKPerBlock / kBlockSize, static_cast<index_t>(8 / sizeof(A0DataType)));
    ...
    CK_TILE_HOST_DEVICE static constexpr auto MakeA0LdsBlockDescriptor()
    {
        ...
        constexpr auto a0_lds_block_desc_0 =
            make_naive_tensor_descriptor(make_tuple(number<kMaxK / kKPerBlock>{},
                                                    number<kKPerBlock / kKPack>{},
                                                    number<kMPerBlock>{},
                                                    number<kKPack>{}),
                                         make_tuple(number<(kMPerBlock + 1) * kKPerBlock>{},
                                                    number<(kMPerBlock + 1) * kKPack>{},
                                                    number<kKPack>{},
                                                    number<1>{}),
                                         number<4>{},
                                         number<1>{});
        ...
        constexpr auto a0_lds_block_desc = transform_tensor_descriptor(
            ...
            make_tuple(make_pass_through_transform(number<kMPerBlock>{}),
                       make_merge_transform(make_tuple(number<kMaxK / kKPerBlock>{},
                                                       number<kKPerBlock / kKPack>{},
                                                       number<kKPack>{}))),
    ...
    CK_TILE_HOST_DEVICE static constexpr auto MakeA1DramTileDistribution()
    {
        ...
        constexpr index_t K2 =
            min(kMPerBlock * kKPerBlock / kBlockSize, static_cast<index_t>(8 / sizeof(A1DataType)));
        constexpr index_t K1 = kKPerBlock / K2;
        constexpr index_t K0 = kMaxK / kKPerBlock;
        constexpr index_t M2 = get_warp_size() / K1;
        constexpr index_t M1 = kBlockSize / get_warp_size();
    ...
    CK_TILE_HOST_DEVICE static constexpr auto MakeA1LdsBlockDescriptor()
    {
        ...
        constexpr auto a1_lds_block_desc_0 =
            make_naive_tensor_descriptor(make_tuple(number<kMaxK / kKPerBlock>{},
                                                    number<kKPerBlock / kKPack>{},
                                                    number<kMPerBlock>{},
                                                    number<kKPack>{}),
    ...
    CK_TILE_HOST_DEVICE static constexpr auto GetA1B1TBlockGemm()
    {
        ...
        using BlockGemmPolicy =
            BlockGemmASmemBRegCRegV1CustomPolicy<typename Problem::InOutDataType,
                                                 typename Problem::InOutDataType,
                                                 typename Problem::GemmAccDataType,
                                                 typename Problem::GemmTileShape::GemmBlockWarps,
                                                 decltype(warp_gemm)>;
