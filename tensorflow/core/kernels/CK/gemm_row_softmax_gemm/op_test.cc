...
class GemmRowSoftmaxGemmTest : public OpsTestBase {
 protected:
// RunGemmRowSoftmaxGemmTest(mat_B0, mat_A0, mat_A1,  Keymask, mat_D, batch, seq, head_num, new_head);
 void RunUnfusedGemmRowSoftmaxGemmTest(const std::vector<Eigen::half>& mat_B0,
  ...
  void RunGemmRowSoftmaxGemmTest(const std::vector<Eigen::half>& mat_B0,
    ...
    AddInputFromArray<Eigen::half>(TensorShape({batch, head_num, seq}), mat_B0);   //0
    AddInputFromArray<Eigen::half>(TensorShape({new_head, head_num}), mat_A0);   //1
...
TEST_F(GemmRowSoftmaxGemmTest, Half) {
    ...
    RunUnfusedGemmRowSoftmaxGemmTest(mat_B0, mat_A0, mat_A1, Keymask, mat_D, batch, seq, head_num, new_head);
    RunGemmRowSoftmaxGemmTest(mat_B0, mat_A0, mat_A1,  Keymask, mat_D, batch, seq, head_num, new_head);
}
