...
struct Gemm0RowSoftmaxTileShape<8>
    : ck_tile::GemmTileSetting<typename Gemm0RowSoftmaxBlockTile<8>::tile_lengths,
                               typename Gemm0RowSoftmaxBlockTile<8>::gemm_warps,
                               WarpTile1>
{
};
...
struct Gemm0RowSoftmaxTileShape<16>
    : ck_tile::GemmTileSetting<typename Gemm0RowSoftmaxBlockTile<16>::tile_lengths,
                               typename Gemm0RowSoftmaxBlockTile<16>::gemm_warps,
                               WarpTile1>
{
};
...
struct Gemm0RowSoftmaxTileShape<32>
    : ck_tile::GemmTileSetting<typename Gemm0RowSoftmaxBlockTile<32>::tile_lengths,
                               typename Gemm0RowSoftmaxBlockTile<32>::gemm_warps,
                               WarpTile1>
{
};
...
template <>
struct Gemm1TileShape<16> : ck_tile::GemmTileSetting<typename Gemm1BlockTile<16>::tile_lengths,
...
template <>
struct Gemm1TileShape<32> : ck_tile::GemmTileSetting<typename Gemm1BlockTile<32>::tile_lengths,
...
template <>
struct Gemm1TileShape<64> : ck_tile::GemmTileSetting<typename Gemm1BlockTile<64>::tile_lengths,
