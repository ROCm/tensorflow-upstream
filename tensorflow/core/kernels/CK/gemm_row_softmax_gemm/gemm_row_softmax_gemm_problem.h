...
template <typename InOutDataType_, typename GemmAccDataType_,
          typename SMComputeDataType_, typename MaskDataType_,
          typename GemmRowSoftmaxTileShape_, typename GemmTileShape_>
struct GemmRowSoftmaxGemmProblem {
  ...
  static constexpr index_t kGemm1BlockSize =
      GemmTileShape::GemmNumWarps * get_warp_size();
};
