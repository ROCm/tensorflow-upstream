...
template <typename BlockTile_, // sequence<...> to indicate the tile sizes for M, N, K of one Gemm
          typename GemmBlockWarps_,
          typename GemmWarpTile_>
struct GemmTileSetting
{
    ...
    static_assert(GemmNumWarps > 0, "Invalid number of warps in the tile occurred!");
